"""
Django settings for elphadeal project.
...
SECRET_KEY = 'django-insecure-k%7@@a=e4n!@^k2ffzcx+_=^(uvk5cx-=r=*ico^rj#+ztufvg'
...
WSGI_APPLICATION = 'elphadeal.wsgi.application'
